              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (String? value) {
                    ...
                    if (value.length < 5) {
                      return "Judul harus minimal 5 karakter!";
                    }
                    if (value.length > 200) {
                      return "Judul tidak boleh lebih dari 200 karakter!";
                    }
                    return null;
                  },
                ),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (String? value) {
                    ...
                    if (value.length < 10) {
                      return "Isi berita harus minimal 10 karakter!";
                    }
                    if (value.length > 5000) {
                      return "Isi berita tidak boleh lebih dari 5000 karakter!";
                    }
                    return null;
                  },
                ),
